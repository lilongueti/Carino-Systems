...
case $choice in
  ...
  "2")
    ...
    sudo dnf remove gnome-tour libreoffice-* totem evolution -y
    #Adding repos and updating system
    sudo dnf install https://dl.fedoraproject.org/pub/epel/epel-release-latest-9.noarch.rpm -y && flatpak remote-add --if-not-exists flathub https://flathub.org/repo/flathub.flatpakrepo && sudo dnf update -y
  ...
  "1")
    ...
    sudo dnf install https://dl.fedoraproject.org/pub/epel/epel-release-latest-9.noarch.rpm -y && flatpak remote-add --if-not-exists flathub https://flathub.org/repo/flathub.flatpakrepo && sudo dnf update -y
    #Installing packages
    #Not available in the repo | celluloid keepassxc transmission krita obs-studio wine yt-dlp tldr
    sudo dnf install https://dl.google.com/linux/direct/google-chrome-stable_current_x86_64.rpm thunderbird ntfs-3g gimp htop powertop neofetch mediainfo NetworkManager-tui cmake ncurses-devel lshw gnome-tweaks gnome-extensions-app git xkill libdrm* qt5-qtbase-devel python3-vapoursynth bridge-utils cifs-utils tigervnc-server xrdp dnf-plugins-core -y && flatpak install flathub io.github.celluloid_player.Celluloid org.telegram.desktop com.spotify.Client org.onlyoffice.desktopeditors -y
    support=y
    nvidia=y
    ;;
  ...
  "3")
    ...
    #Removing packages (reasons vary)
    sudo dnf remove gnome-tour libreoffice-* totem -y
    #Adding repos
    ...
    sudo dnf install https://dl.google.com/linux/direct/google-chrome-stable_current_x86_64.rpm thunderbird ntfs-3g gimp htop powertop neofetch mediainfo NetworkManager-tui barrier cmake ncurses-devel lshw gnome-tweaks gnome-extensions-app git xkill libdrm* qt5-qtbase-devel python3-vapoursynth bridge-utils cifs-utils distrobox @"Virtualization Client" tigervnc-server cockpit xrdp powershell dnf-plugins-core -y && flatpak install flathub io.github.celluloid_player.Celluloid com.visualstudio.code com.microsoft.edge org.telegram.desktop us.zoom.Zoom com.dropbox.Client com.spotify.Client org.onlyoffice.desktopeditors com.anydesk.Anydesk com.skype.Client com.microsoft.Teams com.github.gi_lom.dialect com.slack.Slack com.usebottles.bottles org.remmina.Remmina -y
    support=y
    nvidia=y
    sharedfolder=y
    ;;
  ...
  "0")
    echo "Carino profile"
    #Removing packages (reasons vary)
    sudo dnf remove gnome-tour firefox libreoffice-* totem evolution -y
    ...
    #Installing packages
    #sudo dnf install thunderbird ntfs-3g gimp htop powertop neofetch mediainfo NetworkManager-tui barrier cmake ncurses-devel lshw gnome-tweaks gnome-extensions-app git xkill libdrm* qt5-qtbase-devel python3-vapoursynth bridge-utils cifs-utils distrobox @"Virtualization Client" tigervnc-server cockpit xrdp powershell dnf-plugins-core --skip-broken -y && flatpak install flathub io.mpv.Mpv com.visualstudio.code com.microsoft.edge org.telegram.desktop com.spotify.Client org.onlyoffice.desktopeditors com.anydesk.Anydesk com.skype.Client com.github.gi_lom.dialect com.usebottles.bottles org.remmina.Remmina -y
    sudo dnf install keepassxc ntfs-3g telegram-desktop microsoft-edge-stable code librewolf thunderbird transmission gimp krita kdenlive shotcut htop powertop remmina neofetch mediainfo obs-studio barrier wine NetworkManager-tui yt-dlp cmake lshw lm_sensors.x86_64 gnome-tweaks gnome-extensions-app elinks git xkill libdrm* mumble goverlay tldr steam qt5-qtbase-devel python3-vapoursynth bridge-utils cifs-utils distrobox @virtualization libvirt libvirt-devel virt-install qemu-kvm qemu qemu-img python3 python3-pip virt-manager tigervnc-server cockpit xrdp powershell dnf-plugins-core dhcp-server https://download.onlyoffice.com/install/desktop/editors/linux/onlyoffice-desktopeditors.x86_64.rpm --skip-broken -y #&& flatpak install flathub com.visualstudio.code com.microsoft.edge org.telegram.desktop org.onlyoffice.desktopeditors 
    #Installing packages not available in rpm or flatpak repos
    #Compiling and installing packages not available in the repo
...
#Rustdesk (missing cjkuni-uming-fonts, libxdo, libxdio.so.3)
#if command -v rustdesk > /dev/null;
#    then
#        echo "rustdesk is already installed"
#    else
#        sudo dnf install https://github.com/rustdesk/rustdesk/releases/download/1.1.9/rustdesk-1.1.9-fedora28-centos8.rpm -y
#    fi
#fi
#MPV
#echo $mpv
...
if [[ $(hostname) == 'localhost.localdomain' || 'rhel90' ]];
then
...
then
    ...
    echo 'RDP process has been skipped'
fi
