...
case $choice in
  ...
  "2")
    ...
    then
        ...
        wget https://github.com/GloriousEggroll/proton-ge-custom/releases/download/GE-Proton7-10/GE-Proton7-10.tar.gz && sudo tar -xf GE-Proton7-10.tar.gz -C ~/.steam/root/compatibilitytools.d && rm GE-Proton7-10.tar.gz
    fi
    ;&
