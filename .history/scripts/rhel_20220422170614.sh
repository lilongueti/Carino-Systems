...
case $choice in
  ...
  "2")
    ...
    then
        ...
        wget https://github.com/GloriousEggroll/proton-ge-custom/releases/download/GE-Proton7-14/GE-Proton7-14.tar.gz && sudo tar -xf GE-Proton7-14.tar.gz -C ~/.steam/root/compatibilitytools.d && rm GE-Proton7-14.tar.gz
    fi
    ;&
  ...
  "0")
    ...
    sudo dnf install keepassxc librewolf thunderbird transmission gimp krita kdenlive shotcut blender htop powertop remmina neofetch mediainfo microsoft-edge-stable brave-browser code NetworkManager-tui yt-dlp cmake lshw gnome-tweaks gnome-extensions-app git xkill mumble goverlay steam qt5-qtbase-devel python3-vapoursynth bridge-utils cifs-utils@"Virtualization Client" python3 python3-pip virt-manager tigervnc-server xrdp powershell dnf-plugins-core -y && flatpak install flathub org.telegram.desktop com.spotify.Client org.onlyoffice.desktopeditors com.anydesk.Anydesk com.github.gi_lom.dialect com.skype.Client com.usebottles.bottles -y
