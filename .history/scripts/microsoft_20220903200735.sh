...
case $choice in
    "1")
        ...
        sudo dnf install thunderbird https://download.onlyoffice.com/install/desktop/editors/linux/onlyoffice-desktopeditors.x86_64.rpm
        ;;
    "2")
        #Repositories
        ...
        #Installs Alternative packages
        sudo dnf install remmina @virtualization libvirt libvirt-devel virt-install qemu-kvm qemu qemu-img python3 python3-pip virt-manager
        ;;
        *)
