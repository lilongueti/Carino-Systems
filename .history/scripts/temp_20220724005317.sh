...
"1")
    ...
    case $option in
    "1")
        sudo dnf install @workstation-product-environment xrdp -y && sudo systemctl set-default graphical.target
        echo "You have GNOME installed, moving on"
        ;;
    "2")
        sudo dnf install @xfce-desktop-environment xrdp -y && sudo systemctl set-default graphical.target
        echo "You have XFCE installed, moving on"
        ;;
    "3")
        sudo dnf install @kde-desktop-environment xrdp -y && sudo systemctl set-default graphical.target
        echo "You have KDEinstalled, moving on"
        ;;
    "4")
        sudo dnf install @lxqt-desktop-environment xrdp -y && sudo systemctl set-default graphical.target
        echo "You have LXQT installed, moving on"
        ;;
    "5")
        sudo dnf install @cinnamon-desktop-environment xrdp -y && sudo systemctl set-default graphical.target
        echo "You have CINNAMON installed, moving on"
        ;;
    "6")
        sudo dnf install @mate-desktop-environment xrdp -y && sudo systemctl set-default graphical.target
        echo "You have MATE installed, moving on"
        ;;
    "7")
        sudo dnf install @i3-desktop-environment xrdp -y && sudo systemctl set-default graphical.target
        echo "You have i3 installed, moving on"
        ;;
    "8")
        sudo dnf install @basic-desktop-environment xrdp -y && sudo systemctl set-default graphical.target
