...
"1")
    ...
    case $option in
    "1")
        sudo dnf install @workstation-product-environment gnome-tweaks -y && sudo systemctl set-default graphical.target
...
if [ $XDG_SESSION_DESKTOP = "gnome" ] || [ $XDG_SESSION_DESKTOP = "i3" ]
then
