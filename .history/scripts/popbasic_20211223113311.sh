...
sudo apt update -y && sudo apt install mpv chromium-browser keepassxc telegram-desktop thunderbird transmission gimp htop neofetch mediainfo obs-studio wine network-manager yt-dlp cmake gnome-tweaks elinks git xkill -y && flatpak install flathub com.spotify.Client us.zoom.Zoom org.onlyoffice.desktopeditors com.anydesk.Anydesk -y
