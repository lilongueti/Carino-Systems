...
"1")
    ...
    sudo dnf install wget nano curl cmake nasm ncurses-devel git gedit lolcat figlet --skip-broken -y
    ...
    *)
    ...
    then
        ...
        then
            ...
            #xorg-x11-drv-nvidia xorg-x11-drv-nvidia-libs xorg-x11-drv-nvidia-libs.i686 xorg-x11-drv-nvidia-cuda nvidia-driver xorg-x11-drv-nvidia-cuda-libs
            sudo dnf install kernel-headers kernel-devel akmod-nvidia vdpauinfo libva-vdpau-driver libva-utils vulkan nvidia-xconfig ocl-icd-devel opencl-headers -y && sudo nvidia-xconfig && git clone https://github.com/Syllo/nvtop.git && mkdir -p nvtop/build && cd nvtop/build && cmake .. && make && sudo make install && cd ../.. && rm -rf nvtop
        fi
    else
...
"3")
    ...
    case $choice in
      ...
      "1")
        ...
        #Installing packages
        sudo dnf install firefox telegram-desktop google-chrome-stable celluloid keepassxc thunderbird transmission gimp krita htop powertop neofetch mediainfo obs-studio wine NetworkManager-tui yt-dlp lshw lm_sensors.x86_64 gnome-tweaks gnome-extensions-app git xkill lolcat tldr qt5-qtbase-devel python3-vapoursynth bridge-utils cifs-utils tigervnc-server xrdp dnf-plugins-core https://download.anydesk.com/linux/anydesk-6.2.0-1.el8.x86_64.rpm https://download.onlyoffice.com/install/desktop/editors/linux/onlyoffice-desktopeditors.x86_64.rpm --skip-broken -y && flatpak install flathub com.spotify.Client -y
        timeout 180s steam
        ...
        if [ $? == 0 ]
        then
            wget https://github.com/GloriousEggroll/proton-ge-custom/releases/download/GE-Proton7-28/GE-Proton7-28.tar.gz && sudo tar -xf GE-Proton7-28.tar.gz -C ~/.steam/root/compatibilitytools.d && rm GE-Proton7-28.tar.gz
      ...
      "3")
        ...
        #Installing packages
        sudo dnf install firefox celluloid keepassxc thunderbird transmission gimp htop telegram-desktop code microsoft-edge-stable google-chrome-stable powertop remmina neofetch mediainfo obs-studio barrier wine NetworkManager-tui yt-dlp lshw lm_sensors.x86_64 gnome-tweaks gnome-extensions-app elinks git xkill lolcat tldr qt5-qtbase-devel python3-vapoursynth bridge-utils cifs-utils distrobox @virtualization libvirt libvirt-devel virt-install qemu-kvm qemu qemu-img python3 python3-pip virt-manager tigervnc-server cockpit xrdp powershell dnf-plugins-core dhcp-server https://binaries.webex.com/WebexDesktop-CentOS-Official-Package/Webex.rpm https://download.onlyoffice.com/install/desktop/editors/linux/onlyoffice-desktopeditors.x86_64.rpm https://download.anydesk.com/linux/anydesk-6.2.0-1.el8.x86_64.rpm --skip-broken -y && flatpak install flathub us.zoom.Zoom com.dropbox.Client com.spotify.Client com.skype.Client com.microsoft.Teams com.slack.Slack com.usebottles.bottles -y #org.telegram.desktop org.onlyoffice.desktopeditors com.visualstudio.code com.microsoft.edge
      ...
      "0")
        ...
        sudo rpm --import https://packages.microsoft.com/keys/microsoft.asc && sudo sh -c 'echo -e "[code]\nname=Visual Studio Code\nbaseurl=https://packages.microsoft.com/yumrepos/vscode\nenabled=1\ngpgcheck=1\ngpgkey=https://packages.microsoft.com/keys/microsoft.asc" > /etc/yum.repos.d/vscode.repo' && curl https://packages.microsoft.com/config/rhel/7/prod.repo | sudo tee /etc/yum.repos.d/microsoft.repo &&
        ...
        sudo dnf install firefox keepassxc telegram-desktop microsoft-edge-stable powershell code thunderbird transmission gimp htop powertop remmina neofetch mediainfo  obs-studio barrier wine NetworkManager-tui yt-dlp lshw lm_sensors.x86_64 gnome-tweaks gnome-extensions-app elinks git xkill mumble goverlay lolcat tldr steam qt5-qtbase-devel python3-vapoursynth bridge-utils cifs-utils distrobox @virtualization libvirt libvirt-devel virt-install qemu-kvm qemu qemu-img python3 python3-pip virt-manager tigervnc-server cockpit xrdp dnf-plugins-core dhcp-server https://binaries.webex.com/WebexDesktop-CentOS-Official-Package/Webex.rpm https://download.anydesk.com/linux/anydesk-6.2.0-1.el8.x86_64.rpm https://download.onlyoffice.com/install/desktop/editors/linux/onlyoffice-desktopeditors.x86_64.rpm --skip-broken -y #&& flatpak install flathub com.visualstudio.code com.microsoft.edge org.telegram.desktop org.onlyoffice.desktopeditors
