...
"3")
    ...
    case $choice in
      ...
      "1")
        ...
        if [ $? == 0 ]
        then
            wget https://github.com/GloriousEggroll/proton-ge-custom/releases/download/GE-Proton7-27/GE-Proton7-27.tar.gz && sudo tar -xf GE-Proton7-27.tar.gz -C ~/.steam/root/compatibilitytools.d && rm GE-Proton7-27.tar.gz
