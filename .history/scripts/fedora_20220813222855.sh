...
"3")
    ...
    case $choice in
      ...
      "3")
        ...
        sudo dnf install https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-$(rpm -E %fedora).noarch.rpm https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$(rpm -E %fedora).noarch.rpm fedora-workstation-repositories -y && flatpak remote-add --if-not-exists flathub https://flathub.org/repo/flathub.flatpakrepo && sudo dnf update -y
        #Installing packages
        sudo dnf install firefox celluloid keepassxc thunderbird transmission gimp htop telegram-desktop microsoft-edge-stable google-chrome-stable powertop remmina neofetch mediainfo obs-studio barrier wine NetworkManager-tui yt-dlp lshw lm_sensors.x86_64 elinks git xkill lolcat tldr qt5-qtbase-devel python3-vapoursynth bridge-utils cifs-utils bottles distrobox tigervnc-server cockpit xrdp dnf-plugins-core dhcp-server https://go.skype.com/skypeforlinux-64.rpm https://zoom.us/client/latest/zoom_x86_64.rpm https://binaries.webex.com/WebexDesktop-CentOS-Official-Package/Webex.rpm https://download.onlyoffice.com/install/desktop/editors/linux/onlyoffice-desktopeditors.x86_64.rpm https://download.anydesk.com/linux/anydesk-6.2.0-1.el8.x86_64.rpm --skip-broken -y && flatpak install flathub com.dropbox.Client com.spotify.Client com.slack.Slack -y #com.skype.Client us.zoom.Zoom  org.telegram.desktop org.onlyoffice.desktopeditors com.visualstudio.code com.microsoft.edge com.usebottles.bottles
