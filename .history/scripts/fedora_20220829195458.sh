...
"1")
    ...
    "6")
        ...
        ;;
    "7")
        sudo dnf install @i3-desktop-environment scrot xclip -y && sudo systemctl set-default graphical.target
...
"3")
    ...
    case $choice in
      ...
      "2")
        ...
        wget https://github.com/GloriousEggroll/proton-ge-custom/releases/download/GE-Proton7-30/GE-Proton7-30.tar.gz && sudo tar -xf GE-Proton7-30.tar.gz -C ~/.steam/root/compatibilitytools.d && rm GE-Proton7-30.tar.gz
