...
"1")
    ...
    "6")
        ...
        ;;
    "7")
        sudo dnf install @i3-desktop-environment scrot xclip thunar thunar-archive-plugin file-roller -y && sudo systemctl set-default graphical.target
...
"3")
    ...
    case $choice in
      ...
      "3")
        ...
        #Installing packages
        sudo dnf install celluloid microsoft-edge-stable google-chrome-stable remmina barrier keepassxc bottles distrobox cockpit vpnc https://go.skype.com/skypeforlinux-64.rpm https://zoom.us/client/latest/zoom_x86_64.rpm https://packages.microsoft.com/yumrepos/ms-teams/teams-1.5.00.10453-1.x86_64.rpm https://binaries.webex.com/WebexDesktop-CentOS-Official-Package/Webex.rpm https://download.onlyoffice.com/install/desktop/editors/linux/onlyoffice-desktopeditors.x86_64.rpm https://download.anydesk.com/linux/anydesk-6.2.0-1.el8.x86_64.rpm --skip-broken -y && flatpak install flathub com.dropbox.Client com.spotify.Client com.slack.Slack -y #com.skype.Client us.zoom.Zoom  org.telegram.desktop org.onlyoffice.desktopeditors com.visualstudio.code com.microsoft.edge com.usebottles.bottles
      ...
      "4")
        #Removing packages (reasons vary)
        sudo dnf remove rpmfusion-nonfree-release-36-1.noarch gnome-tour libreoffice-* -y
        #Adding repos and updating system
        sudo dnf config-manager --set-enabled google-chrome && sudo dnf update -y
        #Installing packages
        sudo dnf install google-chrome-stable celluloid krita https://download.anydesk.com/linux/anydesk-6.2.0-1.el8.x86_64.rpm https://download.onlyoffice.com/install/desktop/editors/linux/onlyoffice-desktopeditors.x86_64.rpm --skip-broken -y && flatpak install flathub com.spotify.Client -y
      ...
      "0")
        ...
        sudo dnf install microsoft-edge-stable google-chrome-stable code powershell mpv remmina barrier keepassxc mumble goverlay steam bottles distrobox @virtualization libvirt libvirt-devel virt-install qemu-kvm qemu qemu-img python3 python3-pip virt-manager vpnc cargo https://binaries.webex.com/WebexDesktop-CentOS-Official-Package/Webex.rpm https://download.anydesk.com/linux/anydesk-6.2.0-1.el8.x86_64.rpm https://download.onlyoffice.com/install/desktop/editors/linux/onlyoffice-desktopeditors.x86_64.rpm --skip-broken -y #&& flatpak install flathub com.visualstudio.code com.microsoft.edge org.telegram.desktop org.onlyoffice.desktopeditors
        timeout 180s steam
        #Installing Proton EG
        bash <(curl -s https://carino.systems/scripts/protoneg.sh)
